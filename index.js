...
// we gaan hier de character maken
class Player {
    constructor({
        position,
        velocity
    ...
    draw() {
        ...
        c.fillStyle = 'yellow' // de kleur van de character
        c.fill()
        c.closePath()
        c.restore()
    }
...
class Ghost {
    ...
    draw() {
        ...
        c.arc(this.position.x, this.position.y, this.radius, 0,
            Math.PI * 2)
        c.fillStyle = this.scared ? 'blue' : this.color // de kleur van de character
        c.fill()
        c.closePath()
    }
...
if (pellets.length ===0) {
    ...
    boundaries.forEach((boundary) => {
        ...
        // hier houden het bolletje in de map 
        if (
            circleCollidesWithRectangle({
                circle: player,
                rectangle: boundary
...
// Dit is om de charachter te kunnen besturen met je keyboard
